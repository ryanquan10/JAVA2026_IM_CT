/*
 * xkilxx本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动eepyjjsvp
 */
...
/**
 * 需要用本类的，需要自己引入 <dependency> <groupId>com.google.guava</groupId>
 * <artifactId>guava</artifactId> </dependency>
 * 
 * @author tanyaowu 2017年5月23日 下午1:09:55
 */
