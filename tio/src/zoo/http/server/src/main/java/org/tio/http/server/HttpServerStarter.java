/*
 * dnwxockyrtmo本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动bfayb
 */
...
public class HttpServerStarter {
    ...
    // * @throws IOException
    // */
    // public HttpServerStarter(String pageRoot, int serverPort, String contextPath,
    // String[] scanPackages, HttpServerInterceptor httpServerInterceptor) throws
    // IOException {
    // this(pageRoot, serverPort, contextPath, scanPackages, httpServerInterceptor,
    // null, null, null);
    // }
    //
    // /**
    ...
    // */
    // public HttpServerStarter(String pageRoot, int serverPort, String contextPath,
    // String[] scanPackages, HttpServerInterceptor httpServerInterceptor, ICache
    // sessionStore) throws IOException {
    // this(pageRoot, serverPort, contextPath, scanPackages, httpServerInterceptor,
    ...
    // String[] scanPackages, HttpServerInterceptor httpServerInterceptor, ICache
    // sessionStore,
    // SynThreadPoolExecutor tioExecutor, ThreadPoolExecutor groupExecutor) throws
    // IOException {
    // this(pageRoot, serverPort, contextPath, scanPackages, httpServerInterceptor,
    // null, sessionStore, tioExecutor, groupExecutor);
    // }
    //
    // /**
    // * @deprecated
    ...
    // */
    // public HttpServerStarter(String pageRoot, int serverPort, String contextPath,
    // String[] scanPackages, HttpServerInterceptor httpServerInterceptor,
    // HttpSessionListener httpSessionListener, ICache sessionStore,
    // SynThreadPoolExecutor tioExecutor, ThreadPoolExecutor groupExecutor) throws
    // IOException {
    // int port = serverPort;
    //
    ...
    // DefaultHttpRequestHandler requestHandler = new
    // DefaultHttpRequestHandler(httpConfig, routes);
	...
	tioServerConfig = new TioServerConfig(name, httpTioServerHandler, httpTioServerListener, tioExecutor,
		groupExecutor);
	...
	HttpUuid cluUuid = new HttpUuid();
	tioServerConfig.setTioUuid(cluUuid);
    }
