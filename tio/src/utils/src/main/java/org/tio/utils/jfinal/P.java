/*
 * utcoep本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动udpeg
 */
/**
...
public class P {
     ...
     * P.use("other_config.txt", "UTF-8");<br>
     * <br>
     * String userName = P.get("userName");<br>
     * String password = P.get("password");<br>
     * <br>
     * 
     * userName = P.use("other_config.txt").get("userName");<br>
     * password = P.use("other_config.txt").get("password");<br>
     * <br>
     * 
