      ...
      <div class="info-modelbody modelbody">
       ...
       <div class="save_qrCode" id="save_qrCode_box" ref="capture" >
        <div class="">
          ...
          <div class="qrCode-img">
              <vue-qr :logoSrc="logo" :margin="5" ref="Qrcode"  :text="codeValue" :size="198"></vue-qr>
              <span style="letter-spacing:5px">使用夜猫APP扫一扫</span>
              <span style="letter-spacing:5px">{{qrmsg}}</span>
          </div>
        </div>
      </div>
...
export default {
    ...
    data(){
        return{
            logo:require("@/assets/imgs/common/im-logo1.jpg"),
            qrNick:"",
            user_avatar_1:""
        }
    },
...
.info-modelbody{
  ...
  .qrCode-mask{
    position: absolute;
    background-image: url('~@/assets/imgs/home/bg_qr.jpg');
