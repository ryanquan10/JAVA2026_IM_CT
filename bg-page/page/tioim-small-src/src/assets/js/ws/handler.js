...
var wshandler = function() {
   ...
   */
	this.onmessage = function(event, ws) {
		...
		console.log(wscommand_len, commandstr, commandName, commandReverse);
		if (!commandName) {
		...
		if(Array.isArray(bodyObj.data)){
			console.log('msgdata origin', bodyObj.data);
			console.log('bodyObj', bodyObj);
		}
		console.log('收到消息---commandName----',  commandName);
		console.log('收到消息----bodyObj---',  bodyObj);
