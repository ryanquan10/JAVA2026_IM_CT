/*
 * fundqytwdg本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动oldntwaejaxny
 */
/**
 * 
 */
...
public class YuiJsCompressor implements ResCompressor {
	...
	JavaScriptCompressor compressor = new JavaScriptCompressor(reader, new ErrorReporter() {
		...
		log.error("file:{}, arg0:{}, arg1:{}, arg2:{}, arg3:{}, arg4:{}", filePath, arg0, arg1, arg2, arg3,
			arg4);
	    }
	...
	/**
	 * Writer out, int linebreak, boolean munge, boolean verbose, boolean
	 * preserveAllSemiColons, boolean disableOptimizations
	 */
