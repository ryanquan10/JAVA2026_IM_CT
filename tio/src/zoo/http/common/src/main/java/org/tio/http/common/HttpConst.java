/*
 * lthxewcjjhhkqi本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动ligrwtmhi
 */
...
public interface HttpConst {
	 ...
	 * 请求体的格式
	 * 
	 * @author tanyaowu 2017年6月28日 上午10:03:12
	 */
	...
	/**
	 * Accept-Language : zh-CN,zh;q=0.8 Sec-WebSocket-Version : 13
	 * Sec-WebSocket-Extensions : permessage-deflate; client_max_window_bits Upgrade
	 * : websocket Host : tiocloud.com:9321 Accept-Encoding : gzip, deflate, sdch
	 * User-Agent : Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36
	 * (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36 Origin :
	 * http://www.tiocloud.com:9292 Sec-WebSocket-Key : kmCL2C7q9vtNSMyHpft7lw==
	 * Connection : Upgrade Cache-Control : no-cache Pragma : no-cache
	 *
	 * @author tanyaowu 2017年5月27日 下午2:11:57
	 */
	public interface RequestHeaderKey {
		...
		String	User_Agent			= "user-agent";			// .toLowerCase(); //Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36
		// (KHTML, like Gecko) Chrome/60.0.3088.3 Safari/537.36
		...
		String	Sec_WebSocket_Extensions	= "sec-websocket-extensions";	// .toLowerCase(); //permessage-deflate;
		...
		// boundary=----WebKitFormBoundaryuwYcfA2AIgxqIxA0 】
	...
	/**
	 *
	 * @author tanyaowu 2017年6月27日 下午8:23:58
	 */
	...
	/**
	 *
	 * @author tanyaowu 2017年6月27日 下午8:24:02
	 */
