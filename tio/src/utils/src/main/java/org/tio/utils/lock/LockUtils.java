/*
 * hhdjkhg本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动hiircf
 */
...
public class LockUtils {
    ...
    private static final CaffeineCache LOCAL_LOCKS = CaffeineCache.register(LockUtils.class.getName() + LOCK_TYPE_OBJ,
	    null, 3600L);
    private static final CaffeineCache LOCAL_READWRITE_LOCKS = CaffeineCache
     ...
     * 
     * @param rwLock
     * @param readWriteLockHandler
     * @param readWaitTimeInSecond
     * @throws Exception
     * @author tanyaowu
     */
    public static void runWriteOrWaitRead(ReentrantReadWriteLock rwLock, ReadWriteLockHandler readWriteLockHandler,
	...
	runWriteOrWaitRead(rwLock, readWriteLockHandler, readWaitTimeInSecond);
    }
}
