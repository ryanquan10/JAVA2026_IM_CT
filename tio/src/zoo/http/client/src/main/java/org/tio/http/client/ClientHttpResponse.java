/*
 * xljosq本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动kxivjuhegcst
 */
...
public class ClientHttpResponse extends HttpPacket {
     ...
     * 警告：通过本方法获得Map<String, String>对象后，请勿调用put(key, value)。
     * <p>
     * <p style='color:red;font-size:12pt;'>
     * 添加响应头只能通过HttpResponse.addHeader(String,
     * String)或HttpResponse.addHeaders(Map<String, String> headers)方式添加
     * <p>
     * </span>
     * 
     * @return
	...
	return ret;// requestLine.getPathAndQuery() + System.lineSeparator() +
	// Json.toFormatedJson(params);
    }
