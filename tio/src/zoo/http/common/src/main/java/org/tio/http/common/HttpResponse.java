/*
 * twvprqmg本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动kjehdwq
 */
...
public class HttpResponse extends HttpPacket {
    ...
    // null;//HttpConst.ResponseHeaderKey.Last_Modified
    ...
    //
    // String Connection =
    // StrUtil.lowerCase(request.getHeader(HttpConst.RequestHeaderKey.Connection));
    // RequestLine requestLine = request.getRequestLine();
    // String version = requestLine.getVersion();
    // if ("1.0".equals(version)) {
    // if (StrUtil.equals(Connection,
    // HttpConst.RequestHeaderValue.Connection.keep_alive)) {
    // addHeader(HttpConst.ResponseHeaderKey.Connection,
    // HttpConst.ResponseHeaderValue.Connection.keep_alive);
    // addHeader(HttpConst.ResponseHeaderKey.Keep_Alive, "timeout=10, max=20");
    // } else {
    // addHeader(HttpConst.ResponseHeaderKey.Connection,
    // HttpConst.ResponseHeaderValue.Connection.close);
    // }
    // } else {
    // if (StrUtil.equals(Connection,
    // HttpConst.RequestHeaderValue.Connection.close)) {
    // addHeader(HttpConst.ResponseHeaderKey.Connection,
    // HttpConst.ResponseHeaderValue.Connection.close);
    // } else {
    // addHeader(HttpConst.ResponseHeaderKey.Connection,
    ...
    // // addHeader(HttpConst.ResponseHeaderKey.Date,
    // DatePattern.HTTP_DATETIME_FORMAT.format(SystemTimer.currTime));
     ...
     * @author tanyaowu
     */
    public HeaderValue removeHeader(HeaderName name) {
