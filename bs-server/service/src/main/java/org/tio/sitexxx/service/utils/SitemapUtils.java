...
public class SitemapUtils {
	...
	public static String tioCaseBody(Long cid) {
		return new StringBuilder().append(Const.SITE).append("/2/case/").append(cid).toString();
	}

	public static String tioBlogBody(Long bid) {
		return new StringBuilder().append(Const.SITE).append("/2/blog/").append(bid).toString();
	}
