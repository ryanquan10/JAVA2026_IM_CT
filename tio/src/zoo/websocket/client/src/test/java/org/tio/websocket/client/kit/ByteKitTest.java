/*
 * kxvabyg本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动tdmijlkp
 */
...
public class ByteKitTest {
	...
	assertEquals(parts2.length, bytes1.length % 11 == 0 ? bytes1.length / 11 : bytes1.length / 11 + 1);
	Byte[] combine2 = Arrays.stream(parts2).flatMap(part -> {
