/*
 * khijwczxzqm本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动lybydwy
 */
...
public class WebSocketImpl implements WebSocket {
	...
	ClientHttpRequest httpRequest = new ClientHttpRequest(Method.GET, path, wsClient.uri.getRawQuery());
	...
	return BASE64Util.byteArrayToBase64(SHA1Util.SHA1(secWebsocketKey + "258EAFA5-E914-47DA-95CA-C5AB0DC85B11"))
