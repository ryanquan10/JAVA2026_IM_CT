/*
 * mwszis本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动zvhgydo
 */
...
/**
 * @author tanyaowu 2018年7月1日 上午9:51:04
 */
public class HeaderValue {
	...
	public static final HeaderValue keep_alive = HeaderValue
		.from(HttpConst.ResponseHeaderValue.Connection.keep_alive);
	...
	public static final HeaderValue TEXT_PLAIN_TXT = HeaderValue.Content_Type
		.from(MimeType.TEXT_PLAIN_TXT.getType());
	public static final HeaderValue TEXT_PLAIN_JSON = HeaderValue.Content_Type
		.from(MimeType.TEXT_PLAIN_JSON.getType());
	public static final HeaderValue TEXT_HTML_HTML = HeaderValue.Content_Type
		.from(MimeType.TEXT_HTML_HTML.getType());
