/*
 * bwyrzq本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动wbrtgih
 */
...
/**
 *
 * @author tanyaowu 2017年4月1日 上午9:31:16
 */
public class ClientChannelContext extends ChannelContext {
	private static final long	serialVersionUID	= 3141338659367506643L;
	...
	public ClientChannelContext(TioConfig tioConfig, AsynchronousSocketChannel asynchronousSocketChannel, Object connectParam) {
		super(tioConfig, asynchronousSocketChannel);
	...
	@Override
	public TioClientConfig getTioConfig() {
		return (TioClientConfig) tioConfig;
	}
