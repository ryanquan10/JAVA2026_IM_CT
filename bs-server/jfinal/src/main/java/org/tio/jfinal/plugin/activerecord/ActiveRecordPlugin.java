...
import org.tio.jfinal.plugin.IPlugin;
import org.tio.jfinal.plugin.activerecord.cache.ICache;
import org.tio.jfinal.plugin.activerecord.dialect.Dialect;
import org.tio.jfinal.plugin.activerecord.sql.SqlKit;
...
public class ActiveRecordPlugin implements IPlugin {
	...
	public ActiveRecordPlugin addSqlTemplate(org.tio.jfinal.template.source.ISource sqlTemplate) {
		config.sqlKit.addSqlTemplate(sqlTemplate);
		return this;
	}
	...
	public org.tio.jfinal.template.Engine getEngine() {
	...
	public static void useAsDataTransfer(IContainerFactory containerFactory) {
		useAsDataTransfer(new org.tio.jfinal.plugin.activerecord.dialect.MysqlDialect(), containerFactory, new org.tio.jfinal.plugin.activerecord.cache.EhCache());
	}
	...
	public static void useAsDataTransfer(Dialect dialect, IContainerFactory containerFactory) {
		useAsDataTransfer(dialect, containerFactory, new org.tio.jfinal.plugin.activerecord.cache.EhCache());
	}
	...
	public static void useAsDataTransfer(Dialect dialect) {
		useAsDataTransfer(dialect, IContainerFactory.defaultContainerFactory, new org.tio.jfinal.plugin.activerecord.cache.EhCache());
	}
	...
	public static void useAsDataTransfer() {
		useAsDataTransfer(new org.tio.jfinal.plugin.activerecord.dialect.MysqlDialect(), IContainerFactory.defaultContainerFactory, new org.tio.jfinal.plugin.activerecord.cache.EhCache());
	}
