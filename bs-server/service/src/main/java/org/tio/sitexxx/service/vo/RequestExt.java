...
public class RequestExt implements java.io.Serializable {
	...
	/**
	 * 是否是pc client(用java或c写的client)
	 */
	private boolean		fromPcClient		= false;
	/**
	 * 是否是App
	 */
	 ...
	 * app统一设备
	 */
	private short	appDevice	= Devicetype.WEB.getValue();
	/**
	 * 枚举，见：org.tio.sitexxx.service.Const.DeviceType-原始设备信息
	 */
	...
	public short getAppDevice() {
		return appDevice;
	}

	public void setAppDevice(short appDevice) {
		this.appDevice = appDevice;
	}

	/**
	 * 是否是pc client(用java或c写的client)
	 * @return the fromPcClient
	 */
	public boolean isFromPcClient() {
		return fromPcClient;
	}

	/**
	 * @param fromPcClient the fromPcClient to set
	 */
	public void setFromPcClient(boolean fromPcClient) {
		this.fromPcClient = fromPcClient;
	}
}
