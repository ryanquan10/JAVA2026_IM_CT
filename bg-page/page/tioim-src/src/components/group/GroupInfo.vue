  ...
  <div class="maincontent">
    <div class="infohead" id="infohead" v-show="hasGroup">
      ...
      <div class="head_right_box">
        <div class="icon_qr cursor" @click="showQrCode">
          <p></p>
        </div>
        <img class="icon_setup cursor" src="~@/assets/imgs/group/icon_setup.png" @click.stop="showGroupSet" alt="" srcset="">
      </div>
      <ul :class="['contextmenu-ul t1vcgnmo', 'groupSet',(groupUser.grouprole==1||groupUser.grouprole==3)?'contextmenu-width':'']" v-show="groupSet&&(groupUser.grouprole==1||groupUser.grouprole==3)" style="z-index:888">
        <li>
          <span>开启成员邀请</span>
        ...
        <ul class="memberlist">
          ...
          <li class="memeber-col" v-for="v in groupMember" :key="v.uid" :uid="v.uid">
            <!-- 
                       ...
                       -->
            <el-image class="user-avatar" :src="v.avatar" @click.stop="showCard($event,v.uid)" @contextmenu.prevent="chatContextMenu($event,v)">
