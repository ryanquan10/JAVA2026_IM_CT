...
public class DouyinLogin extends Auth2Login {
	 ...
	 * 获取授权码
	 */
	public static final String	OAUTH_CONNECT_URL		= "https://open.douyin.com/platform/oauth/connect?client_key=" + AppID
	        + "&response_type=code&scope=user_info&state={0}&redirect_uri={1}";
	/**
	 * 获取access_token
	 */
	public static final String	OAUTH_ACCESSTOKEN_URL	= "https://open.douyin.com/oauth/access_token/?client_key=" + AppID + "&client_secret=" + AppSecret
