...
<script>
// import '@_/node_modules/kindeditor/kindeditor-all.js'
...
export default {
  ...
  props: {
    ...
    items: {
      ...
      default: function () {
        return [
          'source', '|', 'code', 'undo', 'redo',
          '|', 'justifyleft', 'justifycenter', 'justifyright',
          'justifyfull', 'insertorderedlist','insertunorderedlist', 'clearhtml','quickformat','|','formatblock', 'fontname', 'fontsize', '|', 'textcolor', 'forecolor','hilitecolor', 'bold','italic', 'underline', 'removeformat', '|', 'image',
    ...
    cssData: {
      type: String,
      default: 'body {font-family: "微软雅黑"; font-size: 14px}'
    },
    bodyClass: {
      type: String,
      default: 'ke-content'
