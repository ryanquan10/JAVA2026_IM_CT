...
module.exports = {
    publicPath: process.env.NODE_ENV === 'production' ? '/tioim' : '/', //vueConf.publicPath, // 根域上下文目录
    outputDir: '../tioim', // 构建输出目录
    ...
    devServer: {
        ...
        proxy: {
            "/mytio": {
            //target: "http://127.0.0.1:6060",   // 本地模拟数据服务器
            // target: "http://129.211.52.247:6060",   // 本地模拟数据服务器
               target: "https://api.cqctxc.com",  // 谭聊生产环境模拟数据服务器
              changeOrigin: true,
              pathRewrite: {
