...
public class TioSiteTokenPathAccessStatListener implements org.tio.http.server.stat.token.TokenPathAccessStatListener {
	...
	public TioTokenPathAccessStat toDbObj(TokenAccessStat tokenAccessStat) {
		...
		ret.setServer(org.tio.sitexxx.service.vo.Const.MY_IP);
		return ret;
	}
	...
	private static final int	G1_MAX_COUNT		= ConfService.getInt(CONF_PREFIX + "G1_MAX_COUNT", 200);
	private static final int	G1_MAX_PER_SECOND	= ConfService.getInt(CONF_PREFIX + "G1_MAX_PER_SECOND", 5);

	private static final int	G2_MAX_COUNT		= ConfService.getInt(CONF_PREFIX + "G2_MAX_COUNT", 100);
	private static final int	G2_MAX_PER_SECOND	= ConfService.getInt(CONF_PREFIX + "G2_MAX_PER_SECOND", 10);
