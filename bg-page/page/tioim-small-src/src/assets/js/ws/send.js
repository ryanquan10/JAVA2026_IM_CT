import {wscommand,formatCommand,commandReverse} from '@/assets/js/ws/command.js';
import {tiows} from '@/assets/js/ws/ws.js';
import store from '@/store/index.js';
const wsSend= function (command, bodyObj) {
    let stateWs=store.state.Ws;
    if (stateWs.isConnect || command == wscommand.HandshakeReq || command == wscommand.WxHandshakeReq ) {
