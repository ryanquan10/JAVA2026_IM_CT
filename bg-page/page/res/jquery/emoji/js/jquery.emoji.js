                    ...
                    if (target === $(btn)[0]) {
                        ...
                        if (code) {
                            if (field.nodeName === 'DIV') {
                                ...
                                // insertHtml = '<img class="'+ iconsGroup[i].className || 'emoji_icon' +'" src="' + imgSrc + '"/>';
                ...
                for (var i = 0; i < groupLength; i++) {
                    ...
                    if (alias) {
                        ...
                        that.$content.html(that.$content.html().replace(regexp, function ($0, $1) {
                            ...
                            if (n) {
                                return '<img class="' +  (iconsGroup[i].className || 'emoji_icon')  + '" src="' + path + n + file + '"/>';
                            } else {
                                return $0;
                            }
                        }));
                        ...
                        that.$content.html(that.$content.html().replace(new RegExp(pattern, 'gm'), '<img class="' +  (iconsGroup[i].className || 'emoji_icon')  + '" src="' + path + '$1' + file + '"/>'));
                    }
                }
            }
        }
