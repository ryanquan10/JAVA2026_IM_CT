...
class RetireFrame extends JFrame {
    private static final long serialVersionUID = 5336130622692944309L;
...
class RetireComponent extends JComponent {
    private static final long serialVersionUID = -4858447468418315754L;
	...
	for (i = info.getCurrentAge(); i <= info.getDeathAge(); i++) {
	    ...
	    Double bar = new Rectangle2D.Double(x1, y1, barWidth - 2, height);
	    g2.fill(bar);
