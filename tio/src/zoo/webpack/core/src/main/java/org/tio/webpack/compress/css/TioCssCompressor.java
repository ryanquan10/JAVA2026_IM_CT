/*
 * byfaws本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动ltvwlbunxbsj
 */
...
/**
 * @author tanyaowu 2017年11月17日 上午11:26:21
 */
public class TioCssCompressor implements ResCompressor {
	...
	try {
	    ...
	    // log.warn("CSS压缩后的文件反而较大, init size:{}, after size:{}, file:{}",
