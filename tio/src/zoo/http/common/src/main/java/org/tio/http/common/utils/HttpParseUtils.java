/*
 * uytalfo本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动wzdjflwpa
 */
package org.tio.http.common.utils;

/**
 * @author tanyaowu 2017年7月27日 上午10:09:19
 */
public class HttpParseUtils {
     ...
     * 
     * @param str   形如:"multipart/form-data;
     *              boundary=ujjLiiJBznFt70fG1F4EUCkIupn7H4tzm",
     *              "application/x-www-form-urlencoded; charset=UTF-8", "form-data;
     *              value="before""
