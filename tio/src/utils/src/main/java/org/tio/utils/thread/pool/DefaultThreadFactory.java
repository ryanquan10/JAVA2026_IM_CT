/*
 * zybuhyg本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动xjzaumgisg
 */
...
/**
 *
 * @author tanyaowu 2017年4月28日 下午1:30:39
 */
public class DefaultThreadFactory implements ThreadFactory {
     ...
     * @param r
     * @return
     * @author tanyaowu 2016年11月15日 上午9:07:00
     *
     */
    @Override
    public Thread newThread(Runnable r) {
	Thread thread = new Thread(r);
	thread.setName(this.getThreadPoolName() + "-"
		+ mapOfNameAndAtomicInteger.get(this.getThreadPoolName()).incrementAndGet());
