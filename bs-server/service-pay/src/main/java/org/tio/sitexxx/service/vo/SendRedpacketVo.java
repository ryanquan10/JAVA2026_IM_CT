...
public class SendRedpacketVo implements Serializable {
	...
	private WxWalletSendRedPacket sendRed;

	public WxWalletSendRedPacketLocal getSendRedLocal() {
		return sendRedLocal;
	}

	public void setSendRedLocal(WxWalletSendRedPacketLocal sendRedLocal) {
		this.sendRedLocal = sendRedLocal;
	}

	private WxWalletSendRedPacketLocal sendRedLocal;
	...
	public WxWalletSendRedPacket getSendRed() {
		return sendRed;
	}

	public void setSendRed(WxWalletSendRedPacket sendRed) {
