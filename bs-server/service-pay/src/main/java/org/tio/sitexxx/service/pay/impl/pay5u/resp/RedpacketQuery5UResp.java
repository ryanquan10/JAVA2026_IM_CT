 ...
 */
public class RedpacketQuery5UResp {
	...
	public Map<String, Object> toAllMap() {
		...
		map.put(PayConst.ApiClassName.API_MAP_KEY, PayConst.ApiClassName.REDPACKET_QUERY);
		return map;
	}

	public static RedpacketQuery5UResp toBean(Map<String, Object> map) {
		return BeanUtil.fillBeanWithMap(map, new RedpacketQuery5UResp(), true);
	}
}
