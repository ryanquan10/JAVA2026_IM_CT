/*
 * tpdnmshmjgna本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动aukhyurvyfnly
 */
...
/**
 * @author tanyaowu 2017年6月28日 下午2:20:32
 */
public class RequestLine {
	...
	sb.append(method.value).append(' ').append(initPath);
	if (StrUtil.isNotBlank(queryString)) {
    ...
    /**
     * 用来编码用的 "GET /json?tan=谭耀武 HTTP/1.1" -->"GET
     * /json?tan=%E8%B0%AD%E8%80%80%E6%AD%A6 HTTP/1.1"
     * 
     * @return
     * @author tanyaowu
     */
