...
exports["default"] = {
  ...
  menus: ['head', 'bold', 'fontSize', // 'customFontSize',
 'italic', 'underline', 'strikeThrough', 'indent', 'lineHeight', 'foreColor', 'backColor', 'link', 'list', 'todo', 'justify', 'quote', 'emoticon', 'image', 'video', 'table', 'code', 'splitLine', 'undo', 'redo'],
  ...
  emotions: [{
    ...
    // content -> 数组
    content: [
    { src:'/res/emoji/emoji/1f642.png', alt: '[微笑]' },
		{ src:'/res/emoji/emoji/1f643.png', alt: '[微笑倒]' },
		{ src:'/res/emoji/emoji/12639.png', alt: '[不开心]' },
		{ src:'/res/emoji/emoji/1f602.png', alt: '[笑哭]' },
		{ src:'/res/emoji/emoji/1f633.png', alt: '[发呆]' },
		{ src:'/res/emoji/emoji/1f60e.png', alt: '[墨镜]' },
		{ src:'/res/emoji/emoji/1f62d.png', alt: '[大哭]' },
		{ src:'/res/emoji/emoji/1f60a.png', alt: '[可爱]' },
		{ src:'/res/emoji/emoji/1f910.png', alt: '[哑]' },
		{ src:'/res/emoji/emoji/1f634.png', alt: '[睡]' },
		{ src:'/res/emoji/emoji/1f622.png', alt: '[哭]' },
		{ src:'/res/emoji/emoji/1f605.png', alt: '[囧]' },
		{ src:'/res/emoji/emoji/1f621.png', alt: '[怒]' },
		{ src:'/res/emoji/emoji/1f61c.png', alt: '[调皮]' },
		{ src:'/res/emoji/emoji/1f604.png', alt: '[笑]' },
		{ src:'/res/emoji/emoji/1f631.png', alt: '[惊讶]' },
		{ src:'/res/emoji/emoji/1f641.png', alt: '[难过]' },
		{ src:'/res/emoji/emoji/1f913.png', alt: '[酷]' },
		{ src:'/res/emoji/emoji/1f625.png', alt: '[汗]' },
		{ src:'/res/emoji/emoji/1f62b.png', alt: '[抓狂]' },
		{ src:'/res/emoji/emoji/1f92e.png', alt: '[吐]' },
		{ src:'/res/emoji/emoji/1f606.png', alt: '[大笑]' },
		{ src:'/res/emoji/emoji/1f601.png', alt: '[快乐]' },
		{ src:'/res/emoji/emoji/1f60f.png', alt: '[得意]' },
		{ src:'/res/emoji/emoji/1f60b.png', alt: '[饿]' },
		{ src:'/res/emoji/emoji/1f635.png', alt: '[累]' },
		{ src:'/res/emoji/emoji/1f628.png', alt: '[吓]' },
		{ src:'/res/emoji/emoji/1f613.png', alt: '[汗]' },
		{ src:'/res/emoji/emoji/1f61d.png', alt: '[高兴]' },
		{ src:'/res/emoji/emoji/1f611.png', alt: '[闲]' },
		{ src:'/res/emoji/emoji/1f920.png', alt: '[努力]' },
		{ src:'/res/emoji/emoji/1f92c.png', alt: '[骂]' },
		{ src:'/res/emoji/emoji/1f914.png', alt: '[疑问]' },
		{ src:'/res/emoji/emoji/1f92b.png', alt: '[秘密]' },
		{ src:'/res/emoji/emoji/1f92f.png', alt: '[乱]' },
		{ src:'/res/emoji/emoji/1f624.png', alt: '[疯]' },
		{ src:'/res/emoji/emoji/1f623.png', alt: '[哀]' },
		{ src:'/res/emoji/emoji/1f608.png', alt: '[坏笑]' },
		{ src:'/res/emoji/emoji/1f923.png', alt: '[笑歪]' },
		{ src:'/res/emoji/emoji/1f917.png', alt: '[bye]' },
		{ src:'/res/emoji/emoji/1f924.png', alt: '[饥饿]' },
		{ src:'/res/emoji/emoji/1f644.png', alt: '[白眼]' },
		{ src:'/res/emoji/emoji/1f60d.png', alt: '[色]' },
		{ src:'/res/emoji/emoji/1f616.png', alt: '[糟糕]' },
		{ src:'/res/emoji/emoji/1f612.png', alt: '[嫌弃]' },
		{ src:'/res/emoji/emoji/1f61a.png', alt: '[亲亲]' },
		{ src:'/res/emoji/emoji/1f609.png', alt: '[wink]' },
		{ src:'/res/emoji/emoji/1f629.png', alt: '[累]' },
		{ src:'/res/emoji/emoji/1f615.png', alt: '[看]' },
		{ src:'/res/emoji/emoji/1f61f.png', alt: '[哀]' },
		{ src:'/res/emoji/emoji/1f61e.png', alt: '[失落]' },
		{ src:'/res/emoji/emoji/1f47f.png', alt: '[坏]' },
		{ src:'/res/emoji/emoji/1f618.png', alt: '[飞吻]' },
		{ src:'/res/emoji/emoji/1f630.png', alt: '[冷汗]' },
		{ src:'/res/emoji/emoji/1f97a.png', alt: '[可怜]' },
		{ src:'/res/emoji/emoji/1f60c.png', alt: '[惬意]' },
		{ src:'/res/emoji/emoji/1f61b.png', alt: '[吐舌]' },
		{ src:'/res/emoji/emoji/1f92a.png', alt: '[鬼脸]' },
		{ src:'/res/emoji/emoji/1f92d.png', alt: '[捂嘴]' },
		{ src:'/res/emoji/emoji/1f614.png', alt: '[失落]' },
		{ src:'/res/emoji/emoji/1f9d0.png', alt: '[傲]' },
		{ src:'/res/emoji/emoji/1f62c.png', alt: '[龇牙]' },
		{ src:'/res/emoji/emoji/1f620.png', alt: '[皱眉]' },
		{ src:'/res/emoji/emoji/1f62a.png', alt: '[鼻涕]' },
		{ src:'/res/emoji/emoji/1f62e.png', alt: '[哦]' },
		{ src:'/res/emoji/emoji/1f632.png', alt: '[噢]' },
		{ src:'/res/emoji/emoji/1f637.png', alt: '[感冒]' },
		{ src:'/res/emoji/emoji/1f912.png', alt: '[发烧]' },
		{ src:'/res/emoji/emoji/1f927.png', alt: '[伤风]' },
		{ src:'/res/emoji/emoji/1f627.png', alt: '[啊]' },
		{ src:'/res/emoji/emoji/1f607.png', alt: '[升天]' },
		{ src:'/res/emoji/emoji/1f911.png', alt: '[吐钱]' },
		{ src:'/res/emoji/emoji/1f915.png', alt: '[头疼]' },
		{ src:'/res/emoji/emoji/1f922.png', alt: '[恶心]' },
		{ src:'/res/emoji/emoji/1f925.png', alt: '[说谎]' },
		{ src:'/res/emoji/emoji/1f928.png', alt: '[疑惑]' },
		{ src:'/res/emoji/emoji/1f929.png', alt: '[眼冒金星]' },
		{ src:'/res/emoji/emoji/1263a.png', alt: '[舒服]' },
		{ src:'/res/emoji/emoji/1f975.png', alt: '[热]' },
		{ src:'/res/emoji/emoji/1f970.png', alt: '[温暖]' },
		{ src:'/res/emoji/emoji/1f973.png', alt: '[庆祝]' },
		{ src:'/res/emoji/emoji/1f974.png', alt: '[歪嘴]' },
		{ src:'/res/emoji/emoji/1f976.png', alt: '[冻僵]' },
		{ src:'/res/emoji/emoji/1f4a9.png', alt: '[翔]' },
		{ src:'/res/emoji/emoji/1f47b.png', alt: '[幽灵]' },
		{ src:'/res/emoji/emoji/1f47d.png', alt: '[外星人]' },
		{ src:'/res/emoji/emoji/1f63a.png', alt: '[猫笑]' },
		{ src:'/res/emoji/emoji/1f63b.png', alt: '[猫色]' },
		{ src:'/res/emoji/emoji/1f63c.png', alt: '[猫得意]' },
		{ src:'/res/emoji/emoji/1f63d.png', alt: '[猫亲亲]' },
		{ src:'/res/emoji/emoji/1f63e.png', alt: '[猫难过]' },
		{ src:'/res/emoji/emoji/1f63f.png', alt: '[猫冷汗]' },
		{ src:'/res/emoji/emoji/1f638.png', alt: '[猫大笑]' },
		{ src:'/res/emoji/emoji/1f639.png', alt: '[猫笑哭]' },
		{ src:'/res/emoji/emoji/1f640.png', alt: '[猫惊吓]' },
		{ src:'/res/emoji/emoji/1f47e.png', alt: '[怪物]' },
		{ src:'/res/emoji/emoji/1f64a.png', alt: '[不问]' },
		{ src:'/res/emoji/emoji/1f648.png', alt: '[不看]' },
		{ src:'/res/emoji/emoji/1f649.png', alt: '[不听]' },
		{ src:'/res/emoji/emoji/1f47a.png', alt: '[面具]' },
		{ src:'/res/emoji/emoji/1f479.png', alt: '[狮子]' },
		{ src:'/res/emoji/emoji/1f480.png', alt: '[骷髅]' },
		{ src:'/res/emoji/emoji/1f916.png', alt: '[机器人]' },
		{ src:'/res/emoji/emoji/1f921.png', alt: '[小丑]' },
		{ src:'/res/emoji/emoji/2620.png', alt: '[海盗]' },		
		{ src:'/res/emoji/emoji/embrace.png', alt: '[抱抱]' },
		{ src:'/res/emoji/emoji/boxing.png', alt: '[抱拳]' },
		{ src:'/res/emoji/emoji/handshake.png', alt: '[握手]' },
		{ src:'/res/emoji/emoji/1f44c.png', alt: '[OK]' },
		{ src:'/res/emoji/emoji/1f44d.png', alt: '[点赞]' },
		{ src:'/res/emoji/emoji/1f44e.png', alt: '[倒彩]' },
		{ src:'/res/emoji/emoji/1f44b.png', alt: '[挥手]' },
		{ src:'/res/emoji/emoji/1f44a.png', alt: '[拳头]' },
		{ src:'/res/emoji/emoji/1f91a.png', alt: '[手掌]' },
		{ src:'/res/emoji/emoji/1f91b.png', alt: '[出拳]' },
		{ src:'/res/emoji/emoji/270c.png', alt: '[剪刀手]' },
		{ src:'/res/emoji/emoji/1f446.png', alt: '[向上]' },
		{ src:'/res/emoji/emoji/1f447.png', alt: '[向下]' },
		{ src:'/res/emoji/emoji/1f448.png', alt: '[向左]' },
		{ src:'/res/emoji/emoji/1f449.png', alt: '[向右]' },
		{ src:'/res/emoji/emoji/1f595.png', alt: '[鄙视]' },
		{ src:'/res/emoji/emoji/261d.png', alt: '[食指]' },
		{ src:'/res/emoji/emoji/1f919.png', alt: '[666]' },
		{ src:'/res/emoji/emoji/270a.png', alt: '[十]' },
		{ src:'/res/emoji/emoji/1f91e.png', alt: '[九]' },
		{ src:'/res/emoji/emoji/1f596.png', alt: '[八]' },
		{ src:'/res/emoji/emoji/1f91f.png', alt: '[七]' },
		{ src:'/res/emoji/emoji/1f918.png', alt: '[六]' },
		{ src:'/res/emoji/emoji/1f590.png', alt: '[五]' },
		{ src:'/res/emoji/emoji/1f4a3.png', alt: '[炸弹]' },
		{ src:'/res/emoji/emoji/1f4a2.png', alt: '[愤怒]' },
		{ src:'/res/emoji/emoji/1f4a4.png', alt: '[zzz]' },
		{ src:'/res/emoji/emoji/1f4a5.png', alt: '[火花]' },
		{ src:'/res/emoji/emoji/1f4a6.png', alt: '[水滴]' },
		{ src:'/res/emoji/emoji/1f4a8.png', alt: '[尾气]' },
		{ src:'/res/emoji/emoji/1f4ab.png', alt: '[星星]' },
		{ src:'/res/emoji/emoji/1f4af.png', alt: '[100分]' },
		{ src:'/res/emoji/emoji/1f5a4.png', alt: '[黑心]' },
		{ src:'/res/emoji/emoji/1f9e1.png', alt: '[橙心]' },
		{ src:'/res/emoji/emoji/1f49a.png', alt: '[绿心]' },
		{ src:'/res/emoji/emoji/1f49b.png', alt: '[黄心]' },
		{ src:'/res/emoji/emoji/1f49c.png', alt: '[紫心]' },
		{ src:'/res/emoji/emoji/1f499.png', alt: '[蓝心]' },
		{ src:'/res/emoji/emoji/2764.png', alt: '[红心]' },
		{ src:'/res/emoji/emoji/1f494.png', alt: '[心碎]' },
		{ src:'/res/emoji/emoji/1f493.png', alt: '[心动]' },
		{ src:'/res/emoji/emoji/1f497.png', alt: '[心跳]' },
		{ src:'/res/emoji/emoji/1f49e.png', alt: '[心转]' },
		{ src:'/res/emoji/emoji/1f49d.png', alt: '[心结]' },
		{ src:'/res/emoji/emoji/1f495.png', alt: '[两心]' },
		{ src:'/res/emoji/emoji/1f496.png', alt: '[动心]' },
		{ src:'/res/emoji/emoji/1f498.png', alt: '[一见钟情]' },
		{ src:'/res/emoji/emoji/1f49f.png', alt: '[心标]' },
		{ src:'/res/emoji/emoji/2763.png', alt: '[感叹]' },
		{ src:'/res/emoji/emoji/1f48b.png', alt: '[唇印]' },
		{ src:'/res/emoji/emoji/1f573.png', alt: '[洞]' },
		{ src:'/res/emoji/emoji/1f4ac.png', alt: '[消息]' },
		{ src:'/res/emoji/emoji/1f4ad.png', alt: '[想法]' },
		{ src:'/res/emoji/emoji/1f5ef.png', alt: '[对话框]' },
		{ src:'/res/emoji/emoji/1f48c.png', alt: '[情书]' },
  ]
  }
],
...
function default_1(editor) {
  ...
  var tabsConf = (0, _map["default"])(emotions).call(emotions, function (ele) {
    return {
      ...
      tpl: "<div style='width:275px'>" + GenerateExpressionStructure(ele) + "</div>",
      events: [{
        selector: '.eleImg',
        type: 'click',
        fn: function fn(e) {
...
function (_super) {
  ...
  function Code(editor) {
    ...
    var $elem = dom_core_1["default"]('<div class="w-e-menu" data-title="代码"><p class="icon-code"></p></div>');
...
function createShowHideFn(editor) {
  ...
  function showCodeTooltip($code) {
    ...
    $('.icon-code').addClass('icon-code_before')
    var t = function t(text, prefix) {
      if (prefix === void 0) {
        prefix = i18nPrefix;
      }
  ...
  function hideCodeTooltip() {
    ...
    if (tooltip) {
      tooltip.remove();
      tooltip = null;
      $('.icon-code').removeClass('icon-code_before')
    }
  }
