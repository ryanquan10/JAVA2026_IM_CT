/*
 * mbfcxkhlaepph本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动ilxcinj
 */
...
public class HttpRequest extends HttpPacket {
    ...
    /**
     * @author tanyaowu 2017年2月22日 下午4:14:40
     */
    ...
    /**
     * 根据host字段，获取去除端口的纯域名部分的值，形如：www.tiocloud.com, tiocloud.com等值
     * 
     * @return
     * @author tanyaowu
     */
    ...
    /**
     * 获取请求头中的host字段，形如：www.tiocloud.com:8080, www.tiocloud.com等值
     * 
     * @return
     * @author: tanyaowu
     */
	...
	// getHeader(HttpConst.RequestHeaderKey.Accept_Encoding);
