/*
 * doalahkebqtw本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动tmkuxko
 */
...
/**
 * @author tanyaowu 2018年8月5日 下午6:34:56
 */
public class ClassUtil {
     ...
     */
    private static void findClassesByFile(String pkg, String pkgDir, ClassScanHandler classScanHandler)
	    throws ClassNotFoundException {
     ...
     * @throws ClassNotFoundException
     */
    private static void findClassesByJar(String pkgName, JarFile jar, ClassScanHandler classScanHandler)
	    throws ClassNotFoundException {
     ...
     * @throws IOException
     */
    public static void scanPackage(String pkg, ClassScanHandler classScanHandler)
