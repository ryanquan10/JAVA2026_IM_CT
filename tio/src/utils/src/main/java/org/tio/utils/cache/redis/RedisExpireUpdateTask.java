/*
 * kumedhff本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动zliqpimzxutf
 */
 ...
 * 定时更新redis的过期时间
 * 
 * @author tanyaowu 2017年8月14日 下午1:34:06
 */
	...
	new Thread(new Runnable() {
		...
		while (true) {
			...
			for (ExpireVo expireVo : set) {
			    log.debug("更新缓存过期时间, cacheName:{}, key:{}, expire:{}", expireVo.getCacheName(),
				    expireVo.getKey(), expireVo.getTimeToIdleSeconds());
