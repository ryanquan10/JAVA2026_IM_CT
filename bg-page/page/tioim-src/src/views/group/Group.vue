...
<div class="mainbody">
	<div class="listcontent">
		...
		<!-- 群聊列表 -->
		<GroupList ref="grouplist" v-show="!searchShow" :groupid="groupid" @setGroupId="setGroupId" @sendCard="sendCard" @sendMsg="sendMsg"></GroupList>
	</div>
	<!-- 好友信息 -->
	<GroupInfo ref="groupinfo" :groupid="groupid" @sendCard="sendCard" @sendMsg="sendMsg"></GroupInfo>
	<!-- 发送名片 -->
