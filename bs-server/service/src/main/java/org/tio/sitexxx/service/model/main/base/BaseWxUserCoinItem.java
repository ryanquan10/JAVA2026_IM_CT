...
public abstract class BaseWxUserCoinItem<M extends BaseWxUserCoinItem<M>> extends TioModel<M> implements IBean {
	 ...
	 * 其它费用
	 */
	public void setOthercny(java.lang.Double othercny) {
	 ...
	 * 其它费用
	 */
	public java.lang.Double getOthercny() {
		return getDouble("othercny");
	}

	/**
	 * 类型：1：充值；2：体现；3：抢红包；4：银行卡消费；5：银行卡退款
	 */
