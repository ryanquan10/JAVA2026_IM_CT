...
public class OscLogin extends Auth2Login {
	 ...
	 * 获取access_token
	 */
	public static final String	OAUTH_ACCESSTOKEN_URL	= "https://www.oschina.net/action/openapi/token?client_id=" + AppID + "&client_secret=" + AppSecret
	        + "&code={0}&grant_type=authorization_code&dataType=json&redirect_uri={1}";
	/**
	 * 获取用户信息
	 */
