...
import org.tio.jfinal.kit.LogKit;
...
import org.tio.jfinal.plugin.activerecord.sql.proxy.ProxyConnection;
...
public class Config {
	...
	public Connection getConnection() throws SQLException {
		...
		if (conn != null)
			return conn;
		return showSql ? new ProxyConnection(dataSource.getConnection()) : dataSource.getConnection();
	}
