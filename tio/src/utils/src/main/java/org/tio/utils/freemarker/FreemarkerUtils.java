/*
 * qvemnwwlegwb本软件由黄庆辉采购自杭州钛特云科技有限公司，黄庆辉需严格遵守合同，不得以任何形式转卖源代码，不得利用本软件从事违法犯罪活动uwccgd
 */
 ...
 * 
 * @author tanyaowu 2017年11月13日 下午3:09:21
 */
public class FreemarkerUtils {
     ...
     * @throws IOException
     */
    public static String generateStringByPath(String template, Configuration configuration)
     ...
     * @throws TemplateException
     */
    public static String generateStringByPath(String template, Configuration configuration, Object model)
	    throws IOException, TemplateException {
