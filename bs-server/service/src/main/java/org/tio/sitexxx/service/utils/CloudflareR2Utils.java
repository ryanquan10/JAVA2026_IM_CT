...
public class CloudflareR2Utils {
    ...
    private static S3Client buildS3Client() {
        AwsBasicCredentials credentials = AwsBasicCredentials.create(
                Const.CloudflareR2.R2_ACCESS_KEY,
                Const.CloudflareR2.R2_SECRET_KEY
        );

        return S3Client.builder()
                .endpointOverride(URI.create(Const.CloudflareR2.R2_ENDPOINT))
    ...
    public static String getPublicObjectUrl(String bucketName, String objectKey) {
        return String.format("%s/%s/%s", Const.CloudflareR2.R2_ENDPOINT, bucketName, objectKey);
    }
